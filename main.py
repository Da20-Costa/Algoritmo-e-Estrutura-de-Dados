# Em uma lista já ordenada, pois ele vai passar uma vez, ver que não houve trocas, e a flag houve_troca vai continuar sendo falsa, fazendo com que o break do loop seja acionado. Nesse cenário, o melhor caso se trona O(n) 
from bubble_sort import bubble_sort, bubble_sort_otimizado
from utilitarios import ler_lista_usuario, exibir_resultado, gerar_lista_aleatoria, gerar_lista_quase_ordenada
...
def executar_comparacao_rapida():
    ...
    print(f"Resultado Bubble Sort otimizado: {str(resultado_bubble)}")
    print(f"Resultado Selection Sort: {str(resultado_selection)}")
